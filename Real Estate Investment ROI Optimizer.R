...
ggplot(lasso_final_coefs, aes(x = reorder(Feature, Coefficient), y = Coefficient, fill = Coefficient > 0)) +
  geom_col() + coord_flip() +
  labs(title = "Key ROI Drivers: Lasso Coefficients", x = "Property Feature", y = "Impact on Price") +
  theme_minimal()
...
corrplot(cor_matrix, method = "color", type = "upper", 
         ...
         addCoef.col = "grey", number.cex = 0.6)
